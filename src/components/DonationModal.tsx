...
<body>
  ...
  return (
    <div 
      className="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-3 sm:p-4"
      onClick={(e) => {
    ...
    >
      <div id="modal-container" className="bg-white dark:bg-gray-800 rounded-2xl sm:rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-700 w-full max-w-xl overflow-hidden relative max-h-[92vh] sm:max-h-[90vh] flex flex-col">
        
        {/* Header toolbar */}
        <div className="px-4 sm:px-6 py-3.5 sm:py-4 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between text-gray-900 dark:text-white shrink-0">
