...
export default function PageViews({
  ...
  // Testimonial Carousel State & Data directly from live database
  ...
  return (
    <div id="page-views-wrapper" className="space-y-12">
      ...
      {currentView === 'home' && (
        <>
          {/* Main Hero block */}
          <section id="hero-section" className="relative py-12 sm:py-16 md:py-20 px-4 sm:px-6 rounded-2xl sm:rounded-3xl overflow-hidden bg-radial from-emerald-800 to-slate-900 text-white flex flex-col items-center text-center">
            ...
            <div className="max-w-3xl relative z-10 space-y-4 sm:space-y-6">
              <span className="inline-block bg-emerald-500/20 text-emerald-300 border border-emerald-500 font-extrabold px-3 py-1.5 rounded-full text-[11px] sm:text-xs tracking-wider uppercase">
                {langPack.legalStatus || 'Yayasan Resmi Berizin Kemensos RI'}
              </span>

              <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tight leading-snug sm:leading-tight md:leading-none text-slate-50">
                {langPack.heroHeadline}
              </h1>

              <p className="text-xs sm:text-sm md:text-base text-gray-300 leading-relaxed max-w-2xl mx-auto font-medium">
                {langPack.heroSubheadline}
              </p>

              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-3.5 pt-3 sm:pt-4 w-full sm:w-auto">
                <button
                  id="hero-btn-donate"
                  onClick={() => onOpenDonateModal()}
                  className="w-full sm:w-auto justify-center bg-emerald-500 hover:bg-emerald-600 font-extrabold px-7 py-3.5 rounded-xl transition-all shadow-lg shadow-emerald-500/20 flex items-center gap-2 text-sm cursor-pointer active:scale-95"
                >
                ...
                <button
                  ...
                  className="w-full sm:w-auto justify-center bg-slate-800 hover:bg-slate-700 text-white border border-gray-700 font-bold px-6 py-3.5 rounded-xl transition-all text-sm cursor-pointer shadow-md active:scale-95"
                >
            ...
            <div className="mt-10 sm:mt-16 w-full max-w-4xl border-t border-emerald-500/10 pt-5 sm:pt-6 grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6 text-xs text-gray-300">
              <div className="flex items-center justify-center gap-2.5">
                <ShieldCheck className="w-5 h-5 text-emerald-400 shrink-0" />
                <span className="font-semibold text-center sm:text-left">{langPack.auditBadge || 'Opini Auditor WTP Resmi'}</span>
              </div>
              <div className="flex items-center justify-center gap-2.5 border-y sm:border-y-0 sm:border-x border-emerald-500/10 py-2.5 sm:py-0">
                <Award className="w-5 h-5 text-emerald-400 shrink-0" />
                <span className="font-semibold text-center sm:text-left">{t('Sertifikasi BNSP & MUI Syariat')}</span>
              </div>
              <div className="flex items-center justify-center gap-2.5">
                <Smile className="w-5 h-5 text-emerald-400 shrink-0" />
                <span className="font-semibold text-center sm:text-left">{t('100% Amanah Tersalurkan Nyata')}</span>
              </div>
            </div>
          </section>
          ...
          <section id="section-testimoni" className="scroll-mt-24 space-y-8 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-3xl p-6 md:p-12 shadow-sm transition-colors">
            ...
            {testimonialList.length === 0 ? (
              <div className="text-center py-10 text-xs text-slate-400 bg-slate-50 dark:bg-slate-950/50 rounded-2xl border border-slate-200 dark:border-slate-800">
                {t('Belum ada testimoni terdaftar di basis data.')}
              </div>
            ) : (() => {
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="absolute right-1 sm:right-2 md:-right-6 top-1/2 -translate-y-1/2 z-20 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full bg-slate-900/90 hover:bg-emerald-600 text-white border border-slate-700/80 flex items-center justify-center transition-all duration-200 shadow-xl hover:scale-110 active:scale-95 cursor-pointer backdrop-blur-md"
                  >
          ...
          <section id="section-faq" className="scroll-mt-24 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-3xl p-6 md:p-10 space-y-8 shadow-sm transition-colors">
            ...
            <div className="max-w-3xl mx-auto space-y-3.5">
              {faqs.length === 0 ? (
                <div className="text-center py-8 text-xs text-slate-400 bg-gray-50/50 dark:bg-slate-950/40 rounded-2xl border border-gray-200 dark:border-slate-800">
                  {t('Belum ada pertanyaan FAQ tercatat di basis data.')}
                </div>
              ) : (
                faqs.map((faqItem) => {
          ...
          {/* SECTION PRICING & MEMBERSHIP (PREMIUM HIGH-CONTRAST LIGHT & DARK MODE) */}
          <section id="section-pricing" className="scroll-mt-24 space-y-8">
            <div className="text-center max-w-2xl mx-auto space-y-3.5 px-4">
              <span className="inline-flex items-center gap-2 bg-emerald-100 dark:bg-emerald-950/80 text-emerald-800 dark:text-emerald-300 border border-emerald-300 dark:border-emerald-500/50 text-[11px] font-black px-4 py-1.5 rounded-full uppercase tracking-wider shadow-xs">
              ...
              <div className="pt-2 flex items-center justify-center">
                <div className="bg-slate-100 dark:bg-slate-900 p-1.5 rounded-2xl inline-flex items-center border border-slate-300 dark:border-slate-700 shadow-sm">
                  <button
                    type="button"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
              ...
              <div className="bg-white dark:bg-slate-900 rounded-3xl border-2 border-slate-200 dark:border-slate-800 p-6 md:p-8 flex flex-col justify-between shadow-md hover:shadow-xl hover:border-slate-300 dark:hover:border-slate-700 transition-all">
                <div className="space-y-5">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs font-bold px-3 py-1 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-200 border border-slate-300 dark:border-slate-700">
                      Free
                    </span>
                  </div>
                  ...
                  <div className="pt-3 border-t border-slate-200 dark:border-slate-800">
                    <div className="flex items-baseline gap-1.5">
                      <span className="text-3xl sm:text-4xl font-black text-slate-900 dark:text-white">Rp 0</span>
                      <span className="text-xs font-bold text-slate-600 dark:text-slate-300">/{t('selamanya')}</span>
                    </div>
                  ...
                  <ul className="space-y-3.5 text-xs text-slate-700 dark:text-slate-200 font-medium pt-2">
                ...
                <div className="pt-6 mt-6 border-t border-slate-200 dark:border-slate-800">
                  <button
                    type="button"
                    onClick={() => onOpenDonateModal()}
                    className="w-full py-3.5 px-4 rounded-xl border-2 border-slate-900 dark:border-slate-700 font-bold text-xs text-slate-900 dark:text-white hover:bg-slate-900 hover:text-white dark:hover:bg-slate-800 transition-colors cursor-pointer text-center"
                  >
              ...
              <div className="bg-gradient-to-b from-emerald-50 via-white to-white dark:from-emerald-950/70 dark:via-slate-900 dark:to-[#0B132B] rounded-3xl border-2 border-emerald-500 p-6 md:p-8 flex flex-col justify-between shadow-xl shadow-emerald-600/10 dark:shadow-emerald-950/40 relative overflow-hidden">
                <div className="absolute top-0 right-0 bg-emerald-600 text-white text-[10px] font-black uppercase tracking-wider px-4 py-1.5 rounded-bl-2xl shadow-md">
                  {t('REKOMENDASI')}
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="pt-3 border-t border-emerald-500/20">
                    <div className="flex items-baseline gap-1.5">
                      ...
                      <span className="text-xs font-bold text-slate-600 dark:text-slate-300">/{t('bulan')}</span>
                    </div>
                  ...
                  <ul className="space-y-3.5 text-xs text-slate-800 dark:text-slate-100 font-medium pt-2">
                    <li className="flex items-start gap-2.5 font-bold text-emerald-800 dark:text-emerald-300">
                      <CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400 shrink-0 mt-0.5" />
                ...
                <div className="pt-6 mt-6 border-t border-emerald-500/20">
                  <button
                    ...
                    className="w-full py-3.5 px-4 rounded-xl bg-emerald-600 hover:bg-emerald-500 font-black text-xs text-white shadow-lg shadow-emerald-600/30 transition-all cursor-pointer text-center flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-[0.98]"
                  >
              ...
              <div className="bg-white dark:bg-slate-900 rounded-3xl border-2 border-slate-200 dark:border-slate-800 p-6 md:p-8 flex flex-col justify-between shadow-md hover:shadow-xl hover:border-emerald-300 dark:hover:border-emerald-700 transition-all">
                <div className="space-y-5">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-xl font-black text-slate-900 dark:text-white">
                    ...
                    <span className="text-xs font-bold px-3 py-1 rounded-full bg-teal-100 dark:bg-teal-950/60 text-teal-800 dark:text-teal-300 border border-teal-300 dark:border-teal-700">
                      Enterprise
                    </span>
                  </div>
                  ...
                  <ul className="space-y-3.5 text-xs text-slate-700 dark:text-slate-200 font-medium pt-2">
                    <li className="flex items-start gap-2.5 font-bold text-teal-800 dark:text-teal-300">
                ...
                <div className="pt-6 mt-6 border-t border-slate-200 dark:border-slate-800">
                  <button
                    ...
                    className="w-full py-3.5 px-4 rounded-xl border-2 border-emerald-600 dark:border-emerald-400 text-emerald-700 dark:text-emerald-300 hover:bg-emerald-50 dark:hover:bg-emerald-950/40 font-bold text-xs transition-colors cursor-pointer text-center"
                  >
            ...
            {/* Note & Guarantee */}
            <div className="bg-emerald-50 dark:bg-emerald-950/30 border-2 border-emerald-200 dark:border-emerald-500/30 rounded-2xl p-4 text-center shadow-xs">
