                              ...
                              {donors.length === 0 ? (
                                <tr>
                                  <td colSpan={6} className="py-8 text-center text-xs text-slate-400">
                                    Belum ada data donatur tercatat di basis data MySQL.
                                  </td>
                                </tr>
                              ) : (
                                donors
                                  ...
                                  .map((dnr) => (
                                    <tr key={dnr.id} className="hover:bg-slate-50/70 dark:hover:bg-slate-800/50 transition-colors">
                                      <td className="py-2.5 pr-2 whitespace-nowrap">
                                        ...
                                        <div className="text-[9px] text-slate-400">{dnr.city || 'Indonesia'}</div>
                                      </td>
                                      <td className="py-2.5 px-2 whitespace-nowrap">
                                        <div className="text-slate-600 dark:text-slate-300 truncate max-w-[130px]">{dnr.email}</div>
                                        <div className="text-[9px] text-slate-400">{dnr.whatsapp || '-'}</div>
                                      </td>
                                      ...
                                      <td className="py-2.5 px-2 text-center text-slate-500 dark:text-slate-400 font-medium whitespace-nowrap">
                                        {(dnr as any).createdDate ? new Date((dnr as any).createdDate).toLocaleDateString('id-ID', { day: 'numeric', month: 'short' }) : 'Aktif'}
                                      </td>
